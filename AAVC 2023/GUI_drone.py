...
class DroneControlApp:
    ...
    def create_search_frame(self):
        ...
        self.button_cont = tk.Button(master=self.frame_search, text='Continue',width=button_width,height=button_heigth,command=None)
        self.button_stop = tk.Button(master=self.frame_search, text='Stop',width=button_width,height=button_heigth,command=None)
        self.button_takeGPS = tk.Button(master=self.frame_search, text='Take GPS',width=button_width,height=button_heigth,command=None)
